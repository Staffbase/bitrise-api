...
func (m *V0ArtifactResponseItemModel) validateArtifactType(formats strfmt.Registry) error {
...
func (m *V0ArtifactResponseItemModel) validateTitle(formats strfmt.Registry) error {
