...
func (m *V0AppDeleteRespModel) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v0 app delete resp model based on context it is used
func (m *V0AppDeleteRespModel) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
