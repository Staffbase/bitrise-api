...
func (m *V0CacheItemListResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0CacheItemListResponseModel) validatePaging(formats strfmt.Registry) error {
...
func (m *V0CacheItemListResponseModel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0CacheItemListResponseModel) UnmarshalBinary(b []byte) error {
	var res V0CacheItemListResponseModel
