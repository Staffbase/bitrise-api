...
func (m *V0ArchivedBuildListResponseModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V0ArchivedBuildListResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0ArchivedBuildListResponseModel) validatePaging(formats strfmt.Registry) error {
...
func (m *V0ArchivedBuildListResponseModel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0ArchivedBuildListResponseModel) UnmarshalBinary(b []byte) error {
	var res V0ArchivedBuildListResponseModel
