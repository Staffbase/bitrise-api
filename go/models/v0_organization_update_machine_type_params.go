...
func (m *V0OrganizationUpdateMachineTypeParams) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v0 organization update machine type params based on context it is used
func (m *V0OrganizationUpdateMachineTypeParams) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
