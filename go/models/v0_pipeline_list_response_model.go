...
func (m *V0PipelineListResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0PipelineListResponseModel) validatePaging(formats strfmt.Registry) error {
...
func (m *V0PipelineListResponseModel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0PipelineListResponseModel) contextValidatePaging(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0PipelineListResponseModel) UnmarshalBinary(b []byte) error {
	var res V0PipelineListResponseModel
