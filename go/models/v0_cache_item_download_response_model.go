...
func (m *V0CacheItemDownloadResponseModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V0CacheItemDownloadResponseModel) validateData(formats strfmt.Registry) error {
...
func (m *V0CacheItemDownloadResponseModel) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0CacheItemDownloadResponseModel) UnmarshalBinary(b []byte) error {
	var res V0CacheItemDownloadResponseModel
