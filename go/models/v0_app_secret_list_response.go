...
func (m *V0AppSecretListResponse) validateSecrets(formats strfmt.Registry) error {
...
func (m *V0AppSecretListResponse) contextValidateSecrets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V0AppSecretListResponse) UnmarshalBinary(b []byte) error {
	var res V0AppSecretListResponse
