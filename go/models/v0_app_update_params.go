...
type V0AppUpdateParams struct {
	...
	// The new Apple API key's slug (recommendation: use the UI to set this)
	AppleAPICredentialSlug string `json:"apple_api_credential_slug,omitempty"`
...
func (m *V0AppUpdateParams) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v0 app update params based on context it is used
func (m *V0AppUpdateParams) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
