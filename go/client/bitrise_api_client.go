...
import (
	...
	"github.com/Staffbase/bitrise-api/go/client/operations"
	"github.com/go-openapi/runtime"
	httptransport "github.com/go-openapi/runtime/client"
	"github.com/go-openapi/strfmt"
)

// Default bitrise API HTTP client.
...
// NewHTTPClient creates a new bitrise API HTTP client.
func NewHTTPClient(formats strfmt.Registry) *BitriseAPI {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new bitrise API HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *BitriseAPI {
...
// New creates a new bitrise API client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *BitriseAPI {
	// ensure nullable parameters have default
	if formats == nil {
...
// BitriseAPI is a client for bitrise API.
...
func (c *BitriseAPI) SetTransport(transport runtime.ContextualTransport) {
