...
func (o *AppDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /apps/{app-slug}] app-delete", response, response.Code())
	}
}
...
func (o *AppDeleteOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /apps/{app-slug}][%d] appDeleteOK %s", 200, payload)
}
...
func (o *AppDeleteBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}][%d] appDeleteBadRequest %s", 400, payload)
}
...
func (o *AppDeleteUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}][%d] appDeleteUnauthorized %s", 401, payload)
}
...
func (o *AppDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}][%d] appDeleteNotFound %s", 404, payload)
}
...
func (o *AppDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}][%d] appDeleteInternalServerError %s", 500, payload)
}
