...
func (o *SecretDeleteBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /apps/{app-slug}/secrets/{secret-name}][%d] secretDeleteBadRequest %s", 400, payload)
}
...
func (o *SecretDeleteUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/secrets/{secret-name}][%d] secretDeleteUnauthorized %s", 401, payload)
}
...
func (o *SecretDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/secrets/{secret-name}][%d] secretDeleteNotFound %s", 404, payload)
}
...
func (o *SecretDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/secrets/{secret-name}][%d] secretDeleteInternalServerError %s", 500, payload)
}
