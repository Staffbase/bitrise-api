...
func (o *ArchivedBuildsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/archived-builds] archived-builds-list", response, response.Code())
	}
}
...
func (o *ArchivedBuildsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/archived-builds][%d] archivedBuildsListOK %s", 200, payload)
}
...
func (o *ArchivedBuildsListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/archived-builds][%d] archivedBuildsListBadRequest %s", 400, payload)
}
...
func (o *ArchivedBuildsListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/archived-builds][%d] archivedBuildsListUnauthorized %s", 401, payload)
}
...
func (o *ArchivedBuildsListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/archived-builds][%d] archivedBuildsListNotFound %s", 404, payload)
}
...
func (o *ArchivedBuildsListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/archived-builds][%d] archivedBuildsListInternalServerError %s", 500, payload)
}
