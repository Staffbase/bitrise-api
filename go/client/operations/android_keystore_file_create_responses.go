...
func (o *AndroidKeystoreFileCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type AndroidKeystoreFileCreateCreated struct {
	Payload *models.V0AndroidKeystoreFileUploadResponseModel
}
...
func (o *AndroidKeystoreFileCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files][%d] androidKeystoreFileCreateCreated %s", 201, payload)
}
...
func (o *AndroidKeystoreFileCreateCreated) GetPayload() *models.V0AndroidKeystoreFileUploadResponseModel {
	return o.Payload
}
...
func (o *AndroidKeystoreFileCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0AndroidKeystoreFileUploadResponseModel)
...
func (o *AndroidKeystoreFileCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files][%d] androidKeystoreFileCreateBadRequest %s", 400, payload)
}
...
func (o *AndroidKeystoreFileCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files][%d] androidKeystoreFileCreateUnauthorized %s", 401, payload)
}
...
func (o *AndroidKeystoreFileCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files][%d] androidKeystoreFileCreateNotFound %s", 404, payload)
}
...
func (o *AndroidKeystoreFileCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files][%d] androidKeystoreFileCreateInternalServerError %s", 500, payload)
}
