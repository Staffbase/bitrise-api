...
func (o *BuildCertificateShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type BuildCertificateShowOK struct {
	Payload *models.V0BuildCertificateDownloadResponseModel
}
...
func (o *BuildCertificateShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates/{build-certificate-slug}][%d] buildCertificateShowOK %s", 200, payload)
}
...
func (o *BuildCertificateShowOK) GetPayload() *models.V0BuildCertificateDownloadResponseModel {
	return o.Payload
}
...
func (o *BuildCertificateShowOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0BuildCertificateDownloadResponseModel)
...
func (o *BuildCertificateShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates/{build-certificate-slug}][%d] buildCertificateShowBadRequest %s", 400, payload)
}
...
func (o *BuildCertificateShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates/{build-certificate-slug}][%d] buildCertificateShowUnauthorized %s", 401, payload)
}
...
func (o *BuildCertificateShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates/{build-certificate-slug}][%d] buildCertificateShowNotFound %s", 404, payload)
}
...
func (o *BuildCertificateShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates/{build-certificate-slug}][%d] buildCertificateShowInternalServerError %s", 500, payload)
}
