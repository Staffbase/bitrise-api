...
func NewProvisioningProfileConfirmParams() *ProvisioningProfileConfirmParams {
	return NewProvisioningProfileConfirmParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ProvisioningProfileConfirmParams].
