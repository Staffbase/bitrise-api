...
func (o *GenericProjectFilesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type GenericProjectFilesCreateCreated struct {
	Payload *models.V0ProjectFileStorageUploadResponseModel
}
...
func (o *GenericProjectFilesCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/generic-project-files][%d] genericProjectFilesCreateCreated %s", 201, payload)
}
...
func (o *GenericProjectFilesCreateCreated) GetPayload() *models.V0ProjectFileStorageUploadResponseModel {
	return o.Payload
}
...
func (o *GenericProjectFilesCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0ProjectFileStorageUploadResponseModel)
...
func (o *GenericProjectFilesCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/generic-project-files][%d] genericProjectFilesCreateBadRequest %s", 400, payload)
}
...
func (o *GenericProjectFilesCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/generic-project-files][%d] genericProjectFilesCreateUnauthorized %s", 401, payload)
}
...
func (o *GenericProjectFilesCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/generic-project-files][%d] genericProjectFilesCreateNotFound %s", 404, payload)
}
...
func (o *GenericProjectFilesCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/generic-project-files][%d] genericProjectFilesCreateInternalServerError %s", 500, payload)
}
