...
func (o *AppConfigDatastoreShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppConfigDatastoreShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml][%d] appConfigDatastoreShowOK %s", 200, payload)
}
...
func (o *AppConfigDatastoreShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml][%d] appConfigDatastoreShowBadRequest %s", 400, payload)
}
...
func (o *AppConfigDatastoreShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml][%d] appConfigDatastoreShowUnauthorized %s", 401, payload)
}
...
func (o *AppConfigDatastoreShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml][%d] appConfigDatastoreShowNotFound %s", 404, payload)
}
...
func (o *AppConfigDatastoreShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml][%d] appConfigDatastoreShowInternalServerError %s", 500, payload)
}
