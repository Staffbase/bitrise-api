...
func NewArtifactDeleteParams() *ArtifactDeleteParams {
	return NewArtifactDeleteParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ArtifactDeleteParams].
