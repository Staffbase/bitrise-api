...
func NewSSHKeyCreateParams() *SSHKeyCreateParams {
	return NewSSHKeyCreateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SSHKeyCreateParams].
