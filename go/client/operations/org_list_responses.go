...
func (o *OrgListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *OrgListOK) Error() string {
	...
	return fmt.Sprintf("[GET /organizations][%d] orgListOK %s", 200, payload)
}
...
func (o *OrgListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations][%d] orgListBadRequest %s", 400, payload)
}
...
func (o *OrgListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations][%d] orgListUnauthorized %s", 401, payload)
}
...
func (o *OrgListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations][%d] orgListNotFound %s", 404, payload)
}
...
func (o *OrgListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations][%d] orgListInternalServerError %s", 500, payload)
}
