...
func NewBuildRequestListParams() *BuildRequestListParams {
	return NewBuildRequestListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildRequestListParams].
