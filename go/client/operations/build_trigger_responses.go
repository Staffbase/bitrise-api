...
func (o *BuildTriggerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *BuildTriggerCreated) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/builds][%d] buildTriggerCreated %s", 201, payload)
}
...
func (o *BuildTriggerBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/builds][%d] buildTriggerBadRequest %s", 400, payload)
}
...
func (o *BuildTriggerUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/builds][%d] buildTriggerUnauthorized %s", 401, payload)
}
...
func (o *BuildTriggerNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/builds][%d] buildTriggerNotFound %s", 404, payload)
}
...
func (o *BuildTriggerInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/builds][%d] buildTriggerInternalServerError %s", 500, payload)
}
