...
func NewAppRolesQueryParams() *AppRolesQueryParams {
	return NewAppRolesQueryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [AppRolesQueryParams].
