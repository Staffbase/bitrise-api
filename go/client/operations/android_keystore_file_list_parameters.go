...
func NewAndroidKeystoreFileListParams() *AndroidKeystoreFileListParams {
	return NewAndroidKeystoreFileListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [AndroidKeystoreFileListParams].
