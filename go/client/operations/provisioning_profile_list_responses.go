...
func (o *ProvisioningProfileListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/provisioning-profiles] provisioning-profile-list", response, response.Code())
	}
}
...
func (o *ProvisioningProfileListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileListOK %s", 200, payload)
}
...
func (o *ProvisioningProfileListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileListBadRequest %s", 400, payload)
}
...
func (o *ProvisioningProfileListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileListUnauthorized %s", 401, payload)
}
...
func (o *ProvisioningProfileListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileListNotFound %s", 404, payload)
}
...
func (o *ProvisioningProfileListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileListInternalServerError %s", 500, payload)
}
