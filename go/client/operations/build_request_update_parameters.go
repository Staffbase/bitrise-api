...
func NewBuildRequestUpdateParams() *BuildRequestUpdateParams {
	return NewBuildRequestUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildRequestUpdateParams].
