...
func (o *AndroidKeystoreFileDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AndroidKeystoreFileDeleteOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}][%d] androidKeystoreFileDeleteOK %s", 200, payload)
}
...
func (o *AndroidKeystoreFileDeleteBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}][%d] androidKeystoreFileDeleteBadRequest %s", 400, payload)
}
...
func (o *AndroidKeystoreFileDeleteUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}][%d] androidKeystoreFileDeleteUnauthorized %s", 401, payload)
}
...
func (o *AndroidKeystoreFileDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}][%d] androidKeystoreFileDeleteNotFound %s", 404, payload)
}
...
func (o *AndroidKeystoreFileDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}][%d] androidKeystoreFileDeleteInternalServerError %s", 500, payload)
}
