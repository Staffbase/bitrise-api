...
func (o *CacheItemDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CacheItemDeleteBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items/{cache-item-id}][%d] cacheItemDeleteBadRequest %s", 400, payload)
}
...
func (o *CacheItemDeleteUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items/{cache-item-id}][%d] cacheItemDeleteUnauthorized %s", 401, payload)
}
...
func (o *CacheItemDeleteNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items/{cache-item-id}][%d] cacheItemDeleteNotFound %s", 404, payload)
}
...
func (o *CacheItemDeleteInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items/{cache-item-id}][%d] cacheItemDeleteInternalServerError %s", 500, payload)
}
