...
func NewPipelineListAllParams() *PipelineListAllParams {
	return NewPipelineListAllParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PipelineListAllParams].
...
func (o *PipelineListAllParams) WithStatus(status *string) *PipelineListAllParams {
	o.SetStatus(status)
	return o
}

// SetStatus adds the status to the pipeline list all params.
func (o *PipelineListAllParams) SetStatus(status *string) {
	o.Status = status
}
