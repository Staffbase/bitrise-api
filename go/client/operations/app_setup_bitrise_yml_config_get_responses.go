...
func (o *AppSetupBitriseYmlConfigGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/bitrise.yml/config] app-setup-bitrise-yml-config-get", response, response.Code())
	}
}
...
func (o *AppSetupBitriseYmlConfigGetOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigGetOK %s", 200, payload)
}
...
func (o *AppSetupBitriseYmlConfigGetBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigGetBadRequest %s", 400, payload)
}
...
func (o *AppSetupBitriseYmlConfigGetUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigGetUnauthorized %s", 401, payload)
}
...
func (o *AppSetupBitriseYmlConfigGetNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigGetNotFound %s", 404, payload)
}
...
func (o *AppSetupBitriseYmlConfigGetInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigGetInternalServerError %s", 500, payload)
}
