...
func (o *PipelineAbortReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PipelineAbortBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/abort][%d] pipelineAbortBadRequest %s", 400, payload)
}
...
func (o *PipelineAbortUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/abort][%d] pipelineAbortUnauthorized %s", 401, payload)
}
...
func (o *PipelineAbortNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/abort][%d] pipelineAbortNotFound %s", 404, payload)
}
...
func (o *PipelineAbortInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/abort][%d] pipelineAbortInternalServerError %s", 500, payload)
}
