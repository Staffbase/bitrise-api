...
func (o *AddonsShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /addons/{addon-id}] addons-show", response, response.Code())
	}
}
...
func (o *AddonsShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /addons/{addon-id}][%d] addonsShowOK %s", 200, payload)
}
...
func (o *AddonsShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons/{addon-id}][%d] addonsShowBadRequest %s", 400, payload)
}
...
func (o *AddonsShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons/{addon-id}][%d] addonsShowUnauthorized %s", 401, payload)
}
...
func (o *AddonsShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons/{addon-id}][%d] addonsShowNotFound %s", 404, payload)
}
...
func (o *AddonsShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons/{addon-id}][%d] addonsShowInternalServerError %s", 500, payload)
}
