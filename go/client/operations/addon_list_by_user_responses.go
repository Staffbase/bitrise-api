...
func (o *AddonListByUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AddonListByUserOK) Error() string {
	...
	return fmt.Sprintf("[GET /users/{user-slug}/addons][%d] addonListByUserOK %s", 200, payload)
}
...
func (o *AddonListByUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/addons][%d] addonListByUserBadRequest %s", 400, payload)
}
...
func (o *AddonListByUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/addons][%d] addonListByUserUnauthorized %s", 401, payload)
}
...
func (o *AddonListByUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/addons][%d] addonListByUserNotFound %s", 404, payload)
}
...
func (o *AddonListByUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/addons][%d] addonListByUserInternalServerError %s", 500, payload)
}
