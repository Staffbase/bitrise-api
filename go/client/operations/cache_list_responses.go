...
func (o *CacheListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CacheListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items][%d] cacheListOK %s", 200, payload)
}
...
func (o *CacheListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items][%d] cacheListBadRequest %s", 400, payload)
}
...
func (o *CacheListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items][%d] cacheListUnauthorized %s", 401, payload)
}
...
func (o *CacheListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items][%d] cacheListNotFound %s", 404, payload)
}
...
func (o *CacheListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items][%d] cacheListInternalServerError %s", 500, payload)
}
