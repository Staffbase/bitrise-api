...
func NewBuildListParams() *BuildListParams {
	return NewBuildListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildListParams].
...
func (o *BuildListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.BuildNumber != nil {
		...
		qBuildNumber := conv.FormatInteger(qrBuildNumber)
		if qBuildNumber != "" {
	...
	if o.IsPipelineBuild != nil {
		...
		qIsPipelineBuild := conv.FormatBool(qrIsPipelineBuild)
		if qIsPipelineBuild != "" {
	...
	if o.PullRequestID != nil {
		...
		qPullRequestID := conv.FormatInteger(qrPullRequestID)
		if qPullRequestID != "" {
	...
	if o.Status != nil {
		...
		qStatus := conv.FormatInteger(qrStatus)
		if qStatus != "" {
