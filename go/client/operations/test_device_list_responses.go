...
func (o *TestDeviceListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *TestDeviceListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/test-devices][%d] testDeviceListOK %s", 200, payload)
}
...
func (o *TestDeviceListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/test-devices][%d] testDeviceListBadRequest %s", 400, payload)
}
...
func (o *TestDeviceListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/test-devices][%d] testDeviceListUnauthorized %s", 401, payload)
}
...
func (o *TestDeviceListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/test-devices][%d] testDeviceListNotFound %s", 404, payload)
}
...
func (o *TestDeviceListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/test-devices][%d] testDeviceListInternalServerError %s", 500, payload)
}
