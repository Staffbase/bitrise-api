...
func (o *AppRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppRolesUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /apps/{app-slug}/roles/{role-name}][%d] appRolesUpdateOK %s", 200, payload)
}
...
func (o *AppRolesUpdateUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/roles/{role-name}][%d] appRolesUpdateUnprocessableEntity %s", 422, payload)
}
...
func (o *AppRolesUpdateBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &appRolesUpdateParamsBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataAppRolesUpdateParamsBodyAO1); err != nil {
		return err
	}
...
func (o AppRolesUpdateBody) MarshalJSON() ([]byte, error) {
	...
	appRolesUpdateParamsBodyAO0, err := jsonutils.WriteJSON(o.AppRolesUpdateParamsBodyAllOf0)
	if err != nil {
		return nil, err
	}
	...
	jsonDataAppRolesUpdateParamsBodyAO1, errAppRolesUpdateParamsBodyAO1 := jsonutils.WriteJSON(dataAppRolesUpdateParamsBodyAO1)
...
func (o *AppRolesUpdateBody) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
func (o *AppRolesUpdateOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &appRolesUpdateOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataAppRolesUpdateOKBodyAO1); err != nil {
		return err
	}
...
func (o AppRolesUpdateOKBody) MarshalJSON() ([]byte, error) {
	...
	appRolesUpdateOKBodyAO0, err := jsonutils.WriteJSON(o.AppRolesUpdateOKBodyAllOf0)
	if err != nil {
		return nil, err
	}
	...
	jsonDataAppRolesUpdateOKBodyAO1, errAppRolesUpdateOKBodyAO1 := jsonutils.WriteJSON(dataAppRolesUpdateOKBodyAO1)
...
func (o *AppRolesUpdateOKBody) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
