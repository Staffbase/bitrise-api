...
func (o *ActivityListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ActivityListOK) Error() string {
	...
	return fmt.Sprintf("[GET /me/activities][%d] activityListOK %s", 200, payload)
}
...
func (o *ActivityListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me/activities][%d] activityListBadRequest %s", 400, payload)
}
...
func (o *ActivityListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me/activities][%d] activityListUnauthorized %s", 401, payload)
}
...
func (o *ActivityListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me/activities][%d] activityListNotFound %s", 404, payload)
}
...
func (o *ActivityListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me/activities][%d] activityListInternalServerError %s", 500, payload)
}
