...
func (o *PipelineListAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PipelineListAllOK) Error() string {
	...
	return fmt.Sprintf("[GET /pipelines][%d] pipelineListAllOK %s", 200, payload)
}
...
func (o *PipelineListAllBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pipelines][%d] pipelineListAllBadRequest %s", 400, payload)
}
...
func (o *PipelineListAllUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pipelines][%d] pipelineListAllUnauthorized %s", 401, payload)
}
...
func (o *PipelineListAllNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pipelines][%d] pipelineListAllNotFound %s", 404, payload)
}
...
func (o *PipelineListAllInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /pipelines][%d] pipelineListAllInternalServerError %s", 500, payload)
}
