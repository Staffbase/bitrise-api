...
func (o *AppListByOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppListByOrganizationOK) Error() string {
	...
	return fmt.Sprintf("[GET /organizations/{org-slug}/apps][%d] appListByOrganizationOK %s", 200, payload)
}
...
func (o *AppListByOrganizationBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}/apps][%d] appListByOrganizationBadRequest %s", 400, payload)
}
...
func (o *AppListByOrganizationUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}/apps][%d] appListByOrganizationUnauthorized %s", 401, payload)
}
...
func (o *AppListByOrganizationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}/apps][%d] appListByOrganizationNotFound %s", 404, payload)
}
...
func (o *AppListByOrganizationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}/apps][%d] appListByOrganizationInternalServerError %s", 500, payload)
}
