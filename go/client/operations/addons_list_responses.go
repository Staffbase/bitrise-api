...
func (o *AddonsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AddonsListOK) Error() string {
	...
	return fmt.Sprintf("[GET /addons][%d] addonsListOK %s", 200, payload)
}
...
func (o *AddonsListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons][%d] addonsListBadRequest %s", 400, payload)
}
...
func (o *AddonsListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons][%d] addonsListUnauthorized %s", 401, payload)
}
...
func (o *AddonsListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons][%d] addonsListNotFound %s", 404, payload)
}
...
func (o *AddonsListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /addons][%d] addonsListInternalServerError %s", 500, payload)
}
