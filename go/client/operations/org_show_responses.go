...
func (o *OrgShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *OrgShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /organizations/{org-slug}][%d] orgShowOK %s", 200, payload)
}
...
func (o *OrgShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}][%d] orgShowBadRequest %s", 400, payload)
}
...
func (o *OrgShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}][%d] orgShowUnauthorized %s", 401, payload)
}
...
func (o *OrgShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}][%d] orgShowNotFound %s", 404, payload)
}
...
func (o *OrgShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /organizations/{org-slug}][%d] orgShowInternalServerError %s", 500, payload)
}
