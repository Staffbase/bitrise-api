...
func NewPipelineShowParams() *PipelineShowParams {
	return NewPipelineShowParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PipelineShowParams].
