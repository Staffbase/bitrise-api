...
func (o *PipelineRebuildReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PipelineRebuildBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/rebuild][%d] pipelineRebuildBadRequest %s", 400, payload)
}
...
func (o *PipelineRebuildUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/rebuild][%d] pipelineRebuildUnauthorized %s", 401, payload)
}
...
func (o *PipelineRebuildNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/rebuild][%d] pipelineRebuildNotFound %s", 404, payload)
}
...
func (o *PipelineRebuildPreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/rebuild][%d] pipelineRebuildPreconditionFailed %s", 412, payload)
}
...
func (o *PipelineRebuildInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/pipelines/{pipeline-id}/rebuild][%d] pipelineRebuildInternalServerError %s", 500, payload)
}
