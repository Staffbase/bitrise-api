...
func (o *AppWebhookCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppWebhookCreateOK) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/register-webhook][%d] appWebhookCreateOK %s", 200, payload)
}
...
func (o *AppWebhookCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/register-webhook][%d] appWebhookCreateBadRequest %s", 400, payload)
}
...
func (o *AppWebhookCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/register-webhook][%d] appWebhookCreateUnauthorized %s", 401, payload)
}
...
func (o *AppWebhookCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/register-webhook][%d] appWebhookCreateNotFound %s", 404, payload)
}
...
func (o *AppWebhookCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/register-webhook][%d] appWebhookCreateInternalServerError %s", 500, payload)
}
