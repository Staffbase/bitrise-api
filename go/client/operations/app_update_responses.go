...
func (o *AppUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /apps/{app-slug}][%d] appUpdateOK %s", 200, payload)
}
...
func (o *AppUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}][%d] appUpdateBadRequest %s", 400, payload)
}
...
func (o *AppUpdateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}][%d] appUpdateUnauthorized %s", 401, payload)
}
...
func (o *AppUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}][%d] appUpdateNotFound %s", 404, payload)
}
...
func (o *AppUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}][%d] appUpdateInternalServerError %s", 500, payload)
}
