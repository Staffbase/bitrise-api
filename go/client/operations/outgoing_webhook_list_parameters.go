...
func NewOutgoingWebhookListParams() *OutgoingWebhookListParams {
	return NewOutgoingWebhookListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [OutgoingWebhookListParams].
