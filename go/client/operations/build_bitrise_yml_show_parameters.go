...
func NewBuildBitriseYmlShowParams() *BuildBitriseYmlShowParams {
	return NewBuildBitriseYmlShowParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildBitriseYmlShowParams].
