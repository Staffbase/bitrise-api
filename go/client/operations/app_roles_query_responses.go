...
func (o *AppRolesQueryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppRolesQueryOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/roles/{role-name}][%d] appRolesQueryOK %s", 200, payload)
}
...
func (o *AppRolesQueryNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/roles/{role-name}][%d] appRolesQueryNotFound %s", 404, payload)
}
...
func (o *AppRolesQueryOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &appRolesQueryOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataAppRolesQueryOKBodyAO1); err != nil {
		return err
	}
...
func (o AppRolesQueryOKBody) MarshalJSON() ([]byte, error) {
	...
	appRolesQueryOKBodyAO0, err := jsonutils.WriteJSON(o.AppRolesQueryOKBodyAllOf0)
	if err != nil {
		return nil, err
	}
	...
	jsonDataAppRolesQueryOKBodyAO1, errAppRolesQueryOKBodyAO1 := jsonutils.WriteJSON(dataAppRolesQueryOKBodyAO1)
...
func (o *AppRolesQueryOKBody) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
type AppRolesQueryOKBodyAllOf0 any
