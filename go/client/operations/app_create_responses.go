...
func (o *AppCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /apps/register] app-create", response, response.Code())
	}
}
...
func (o *AppCreateOK) Error() string {
	...
	return fmt.Sprintf("[POST /apps/register][%d] appCreateOK %s", 200, payload)
}
...
func (o *AppCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/register][%d] appCreateBadRequest %s", 400, payload)
}
...
func (o *AppCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/register][%d] appCreateUnauthorized %s", 401, payload)
}
...
func (o *AppCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/register][%d] appCreateNotFound %s", 404, payload)
}
...
func (o *AppCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/register][%d] appCreateInternalServerError %s", 500, payload)
}
