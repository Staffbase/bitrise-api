...
func (o *AddonListByAppReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AddonListByAppOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/addons][%d] addonListByAppOK %s", 200, payload)
}
...
func (o *AddonListByAppBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/addons][%d] addonListByAppBadRequest %s", 400, payload)
}
...
func (o *AddonListByAppUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/addons][%d] addonListByAppUnauthorized %s", 401, payload)
}
...
func (o *AddonListByAppNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/addons][%d] addonListByAppNotFound %s", 404, payload)
}
...
func (o *AddonListByAppInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/addons][%d] addonListByAppInternalServerError %s", 500, payload)
}
