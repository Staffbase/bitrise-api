...
func (o *BuildCertificateCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type BuildCertificateCreateCreated struct {
	Payload *models.V0BuildCertificateUploadResponseModel
}
...
func (o *BuildCertificateCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/build-certificates][%d] buildCertificateCreateCreated %s", 201, payload)
}
...
func (o *BuildCertificateCreateCreated) GetPayload() *models.V0BuildCertificateUploadResponseModel {
	return o.Payload
}
...
func (o *BuildCertificateCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0BuildCertificateUploadResponseModel)
...
func (o *BuildCertificateCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/build-certificates][%d] buildCertificateCreateBadRequest %s", 400, payload)
}
...
func (o *BuildCertificateCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/build-certificates][%d] buildCertificateCreateUnauthorized %s", 401, payload)
}
...
func (o *BuildCertificateCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/build-certificates][%d] buildCertificateCreateNotFound %s", 404, payload)
}
...
func (o *BuildCertificateCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/build-certificates][%d] buildCertificateCreateInternalServerError %s", 500, payload)
}
