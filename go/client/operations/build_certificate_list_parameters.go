...
func NewBuildCertificateListParams() *BuildCertificateListParams {
	return NewBuildCertificateListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildCertificateListParams].
