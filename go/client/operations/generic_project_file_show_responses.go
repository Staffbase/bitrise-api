...
func (o *GenericProjectFileShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}] generic-project-file-show", response, response.Code())
	}
}
...
type GenericProjectFileShowOK struct {
	Payload *models.V0ProjectFileStorageDownloadResponseModel
}
...
func (o *GenericProjectFileShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}][%d] genericProjectFileShowOK %s", 200, payload)
}
...
func (o *GenericProjectFileShowOK) GetPayload() *models.V0ProjectFileStorageDownloadResponseModel {
	return o.Payload
}
...
func (o *GenericProjectFileShowOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0ProjectFileStorageDownloadResponseModel)
...
func (o *GenericProjectFileShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}][%d] genericProjectFileShowBadRequest %s", 400, payload)
}
...
func (o *GenericProjectFileShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}][%d] genericProjectFileShowUnauthorized %s", 401, payload)
}
...
func (o *GenericProjectFileShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}][%d] genericProjectFileShowNotFound %s", 404, payload)
}
...
func (o *GenericProjectFileShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/generic-project-files/{generic-project-file-slug}][%d] genericProjectFileShowInternalServerError %s", 500, payload)
}
