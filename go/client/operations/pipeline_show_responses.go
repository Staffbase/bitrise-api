...
func (o *PipelineShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/pipelines/{pipeline-id}] pipeline-show", response, response.Code())
	}
}
...
func (o *PipelineShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines/{pipeline-id}][%d] pipelineShowOK %s", 200, payload)
}
...
func (o *PipelineShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines/{pipeline-id}][%d] pipelineShowBadRequest %s", 400, payload)
}
...
func (o *PipelineShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines/{pipeline-id}][%d] pipelineShowUnauthorized %s", 401, payload)
}
...
func (o *PipelineShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines/{pipeline-id}][%d] pipelineShowNotFound %s", 404, payload)
}
...
func (o *PipelineShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines/{pipeline-id}][%d] pipelineShowInternalServerError %s", 500, payload)
}
