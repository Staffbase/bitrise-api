...
func (o *CacheItemDeleteAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CacheItemDeleteAllBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items][%d] cacheItemDeleteAllBadRequest %s", 400, payload)
}
...
func (o *CacheItemDeleteAllUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items][%d] cacheItemDeleteAllUnauthorized %s", 401, payload)
}
...
func (o *CacheItemDeleteAllNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items][%d] cacheItemDeleteAllNotFound %s", 404, payload)
}
...
func (o *CacheItemDeleteAllInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /apps/{app-slug}/cache-items][%d] cacheItemDeleteAllInternalServerError %s", 500, payload)
}
