...
func (o *ProvisioningProfileCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type ProvisioningProfileCreateCreated struct {
	Payload *models.V0ProvisionProfileUploadResponseModel
}
...
func (o *ProvisioningProfileCreateCreated) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileCreateCreated %s", 201, payload)
}
...
func (o *ProvisioningProfileCreateCreated) GetPayload() *models.V0ProvisionProfileUploadResponseModel {
	return o.Payload
}
...
func (o *ProvisioningProfileCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0ProvisionProfileUploadResponseModel)
...
func (o *ProvisioningProfileCreateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileCreateBadRequest %s", 400, payload)
}
...
func (o *ProvisioningProfileCreateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileCreateUnauthorized %s", 401, payload)
}
...
func (o *ProvisioningProfileCreateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileCreateNotFound %s", 404, payload)
}
...
func (o *ProvisioningProfileCreateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/provisioning-profiles][%d] provisioningProfileCreateInternalServerError %s", 500, payload)
}
