...
func (o *AppListByUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppListByUserOK) Error() string {
	...
	return fmt.Sprintf("[GET /users/{user-slug}/apps][%d] appListByUserOK %s", 200, payload)
}
...
func (o *AppListByUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/apps][%d] appListByUserBadRequest %s", 400, payload)
}
...
func (o *AppListByUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/apps][%d] appListByUserUnauthorized %s", 401, payload)
}
...
func (o *AppListByUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/apps][%d] appListByUserNotFound %s", 404, payload)
}
...
func (o *AppListByUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user-slug}/apps][%d] appListByUserInternalServerError %s", 500, payload)
}
