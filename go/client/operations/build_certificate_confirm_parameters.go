...
func NewBuildCertificateConfirmParams() *BuildCertificateConfirmParams {
	return NewBuildCertificateConfirmParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildCertificateConfirmParams].
