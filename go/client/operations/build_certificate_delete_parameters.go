...
func NewBuildCertificateDeleteParams() *BuildCertificateDeleteParams {
	return NewBuildCertificateDeleteParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildCertificateDeleteParams].
