...
func (o *CacheItemDownloadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CacheItemDownloadOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items/{cache-item-id}/download][%d] cacheItemDownloadOK %s", 200, payload)
}
...
func (o *CacheItemDownloadBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items/{cache-item-id}/download][%d] cacheItemDownloadBadRequest %s", 400, payload)
}
...
func (o *CacheItemDownloadUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items/{cache-item-id}/download][%d] cacheItemDownloadUnauthorized %s", 401, payload)
}
...
func (o *CacheItemDownloadNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items/{cache-item-id}/download][%d] cacheItemDownloadNotFound %s", 404, payload)
}
...
func (o *CacheItemDownloadInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/cache-items/{cache-item-id}/download][%d] cacheItemDownloadInternalServerError %s", 500, payload)
}
