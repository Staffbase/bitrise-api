...
func (o *AppFinishReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppFinishOK) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/finish][%d] appFinishOK %s", 200, payload)
}
...
func (o *AppFinishBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/finish][%d] appFinishBadRequest %s", 400, payload)
}
...
func (o *AppFinishUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/finish][%d] appFinishUnauthorized %s", 401, payload)
}
...
func (o *AppFinishNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/finish][%d] appFinishNotFound %s", 404, payload)
}
...
func (o *AppFinishInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/finish][%d] appFinishInternalServerError %s", 500, payload)
}
