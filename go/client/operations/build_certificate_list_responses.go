...
func (o *BuildCertificateListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *BuildCertificateListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates][%d] buildCertificateListOK %s", 200, payload)
}
...
func (o *BuildCertificateListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates][%d] buildCertificateListBadRequest %s", 400, payload)
}
...
func (o *BuildCertificateListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates][%d] buildCertificateListUnauthorized %s", 401, payload)
}
...
func (o *BuildCertificateListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates][%d] buildCertificateListNotFound %s", 404, payload)
}
...
func (o *BuildCertificateListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-certificates][%d] buildCertificateListInternalServerError %s", 500, payload)
}
