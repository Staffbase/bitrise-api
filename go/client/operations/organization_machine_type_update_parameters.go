...
func NewOrganizationMachineTypeUpdateParams() *OrganizationMachineTypeUpdateParams {
	return NewOrganizationMachineTypeUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [OrganizationMachineTypeUpdateParams].
