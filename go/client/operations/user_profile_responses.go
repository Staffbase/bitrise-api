...
func (o *UserProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UserProfileOK) Error() string {
	...
	return fmt.Sprintf("[GET /me][%d] userProfileOK %s", 200, payload)
}
...
func (o *UserProfileUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me][%d] userProfileUnauthorized %s", 401, payload)
}
...
func (o *UserProfileNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me][%d] userProfileNotFound %s", 404, payload)
}
...
func (o *UserProfileInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /me][%d] userProfileInternalServerError %s", 500, payload)
}
