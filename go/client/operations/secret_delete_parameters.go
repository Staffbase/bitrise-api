...
func NewSecretDeleteParams() *SecretDeleteParams {
	return NewSecretDeleteParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SecretDeleteParams].
