...
func (o *AppSetupBitriseYmlConfigUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppSetupBitriseYmlConfigUpdateBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigUpdateBadRequest %s", 400, payload)
}
...
func (o *AppSetupBitriseYmlConfigUpdateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigUpdateUnauthorized %s", 401, payload)
}
...
func (o *AppSetupBitriseYmlConfigUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigUpdateNotFound %s", 404, payload)
}
...
func (o *AppSetupBitriseYmlConfigUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/bitrise.yml/config][%d] appSetupBitriseYmlConfigUpdateInternalServerError %s", 500, payload)
}
