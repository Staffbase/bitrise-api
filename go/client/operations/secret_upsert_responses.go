...
func (o *SecretUpsertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SecretUpsertBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /apps/{app-slug}/secrets/{secret-name}][%d] secretUpsertBadRequest %s", 400, payload)
}
...
func (o *SecretUpsertUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/secrets/{secret-name}][%d] secretUpsertUnauthorized %s", 401, payload)
}
...
func (o *SecretUpsertNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/secrets/{secret-name}][%d] secretUpsertNotFound %s", 404, payload)
}
...
func (o *SecretUpsertInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /apps/{app-slug}/secrets/{secret-name}][%d] secretUpsertInternalServerError %s", 500, payload)
}
...
// SecretUpsertBody secret upsert body
//
// swagger:model SecretUpsertBody
...
// Validate validates this secret upsert body
func (o *SecretUpsertBody) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this secret upsert body based on context it is used
func (o *SecretUpsertBody) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *SecretUpsertBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *SecretUpsertBody) UnmarshalBinary(b []byte) error {
	var res SecretUpsertBody
