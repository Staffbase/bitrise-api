...
func (o *AppNotificationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppNotificationsOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /apps/{app-slug}/update-email-notifications][%d] appNotificationsOK %s", 200, payload)
}
...
func (o *AppNotificationsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}/update-email-notifications][%d] appNotificationsBadRequest %s", 400, payload)
}
...
func (o *AppNotificationsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}/update-email-notifications][%d] appNotificationsUnauthorized %s", 401, payload)
}
...
func (o *AppNotificationsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}/update-email-notifications][%d] appNotificationsNotFound %s", 404, payload)
}
...
func (o *AppNotificationsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /apps/{app-slug}/update-email-notifications][%d] appNotificationsInternalServerError %s", 500, payload)
}
