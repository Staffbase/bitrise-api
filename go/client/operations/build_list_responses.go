...
func (o *BuildListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/builds] build-list", response, response.Code())
	}
}
...
func (o *BuildListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/builds][%d] buildListOK %s", 200, payload)
}
...
func (o *BuildListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/builds][%d] buildListBadRequest %s", 400, payload)
}
...
func (o *BuildListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/builds][%d] buildListUnauthorized %s", 401, payload)
}
...
func (o *BuildListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/builds][%d] buildListNotFound %s", 404, payload)
}
...
func (o *BuildListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/builds][%d] buildListInternalServerError %s", 500, payload)
}
