...
func (o *PipelineListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/pipelines] pipeline-list", response, response.Code())
	}
}
...
func (o *PipelineListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines][%d] pipelineListOK %s", 200, payload)
}
...
func (o *PipelineListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines][%d] pipelineListBadRequest %s", 400, payload)
}
...
func (o *PipelineListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines][%d] pipelineListUnauthorized %s", 401, payload)
}
...
func (o *PipelineListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines][%d] pipelineListNotFound %s", 404, payload)
}
...
func (o *PipelineListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/pipelines][%d] pipelineListInternalServerError %s", 500, payload)
}
