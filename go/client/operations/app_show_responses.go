...
func (o *AppShowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AppShowOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}][%d] appShowOK %s", 200, payload)
}
...
func (o *AppShowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}][%d] appShowBadRequest %s", 400, payload)
}
...
func (o *AppShowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}][%d] appShowUnauthorized %s", 401, payload)
}
...
func (o *AppShowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}][%d] appShowNotFound %s", 404, payload)
}
...
func (o *AppShowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}][%d] appShowInternalServerError %s", 500, payload)
}
