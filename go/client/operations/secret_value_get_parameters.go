...
func NewSecretValueGetParams() *SecretValueGetParams {
	return NewSecretValueGetParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SecretValueGetParams].
