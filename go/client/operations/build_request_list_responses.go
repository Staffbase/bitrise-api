...
func (o *BuildRequestListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /apps/{app-slug}/build-requests] build-request-list", response, response.Code())
	}
}
...
func (o *BuildRequestListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/build-requests][%d] buildRequestListOK %s", 200, payload)
}
...
func (o *BuildRequestListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-requests][%d] buildRequestListBadRequest %s", 400, payload)
}
...
func (o *BuildRequestListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-requests][%d] buildRequestListUnauthorized %s", 401, payload)
}
...
func (o *BuildRequestListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-requests][%d] buildRequestListNotFound %s", 404, payload)
}
...
func (o *BuildRequestListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/build-requests][%d] buildRequestListInternalServerError %s", 500, payload)
}
