...
func (o *AndroidKeystoreFileConfirmReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type AndroidKeystoreFileConfirmOK struct {
	Payload *models.V0AndroidKeystoreFileResponseModel
}
...
func (o *AndroidKeystoreFileConfirmOK) Error() string {
	...
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}/uploaded][%d] androidKeystoreFileConfirmOK %s", 200, payload)
}
...
func (o *AndroidKeystoreFileConfirmOK) GetPayload() *models.V0AndroidKeystoreFileResponseModel {
	return o.Payload
}
...
func (o *AndroidKeystoreFileConfirmOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.V0AndroidKeystoreFileResponseModel)
...
func (o *AndroidKeystoreFileConfirmBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}/uploaded][%d] androidKeystoreFileConfirmBadRequest %s", 400, payload)
}
...
func (o *AndroidKeystoreFileConfirmUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}/uploaded][%d] androidKeystoreFileConfirmUnauthorized %s", 401, payload)
}
...
func (o *AndroidKeystoreFileConfirmNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}/uploaded][%d] androidKeystoreFileConfirmNotFound %s", 404, payload)
}
...
func (o *AndroidKeystoreFileConfirmInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /apps/{app-slug}/android-keystore-files/{android-keystore-file-slug}/uploaded][%d] androidKeystoreFileConfirmInternalServerError %s", 500, payload)
}
