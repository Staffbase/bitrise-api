...
func (o *OrganizationMachineTypeUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /organizations/{org-slug}/apps/machine_types] organization-machine-type-update", response, response.Code())
	}
}
...
func (o *OrganizationMachineTypeUpdateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /organizations/{org-slug}/apps/machine_types][%d] organizationMachineTypeUpdateOK %s", 200, payload)
}
...
func (o *OrganizationMachineTypeUpdateBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /organizations/{org-slug}/apps/machine_types][%d] organizationMachineTypeUpdateBadRequest %s", 400, payload)
}
...
func (o *OrganizationMachineTypeUpdateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /organizations/{org-slug}/apps/machine_types][%d] organizationMachineTypeUpdateUnauthorized %s", 401, payload)
}
...
func (o *OrganizationMachineTypeUpdateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /organizations/{org-slug}/apps/machine_types][%d] organizationMachineTypeUpdateNotFound %s", 404, payload)
}
...
func (o *OrganizationMachineTypeUpdateInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /organizations/{org-slug}/apps/machine_types][%d] organizationMachineTypeUpdateInternalServerError %s", 500, payload)
}
