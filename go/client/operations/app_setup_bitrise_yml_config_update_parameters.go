...
func NewAppSetupBitriseYmlConfigUpdateParams() *AppSetupBitriseYmlConfigUpdateParams {
	return NewAppSetupBitriseYmlConfigUpdateParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [AppSetupBitriseYmlConfigUpdateParams].
