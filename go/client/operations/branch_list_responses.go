...
func (o *BranchListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *BranchListOK) Error() string {
	...
	return fmt.Sprintf("[GET /apps/{app-slug}/branches][%d] branchListOK %s", 200, payload)
}
...
func (o *BranchListBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/branches][%d] branchListBadRequest %s", 400, payload)
}
...
func (o *BranchListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/branches][%d] branchListUnauthorized %s", 401, payload)
}
...
func (o *BranchListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/branches][%d] branchListNotFound %s", 404, payload)
}
...
func (o *BranchListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /apps/{app-slug}/branches][%d] branchListInternalServerError %s", 500, payload)
}
