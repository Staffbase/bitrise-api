...
func NewBuildListAllParams() *BuildListAllParams {
	return NewBuildListAllParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [BuildListAllParams].
...
func (o *BuildListAllParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IsOnHold != nil {
		...
		qIsOnHold := conv.FormatBool(qrIsOnHold)
		if qIsOnHold != "" {
